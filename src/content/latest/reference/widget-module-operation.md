...
# Widget Module - iced::widget::operation

This page tracks the module entrypoint defined in ref/doc/iced/widget/operation/index.html.

## Overview

- Module name: operation
- Rustdoc: ref/doc/iced/widget/operation/index.html

## When to use

Use this module when you need the widget family and related styling/state APIs grouped under iced::widget::operation.
