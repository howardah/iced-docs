...
# Widget Module - iced::widget::rule

This page tracks the module entrypoint defined in ref/doc/iced/widget/rule/index.html.

## Overview

- Module name: rule
- Rustdoc: ref/doc/iced/widget/rule/index.html

## When to use

Use this module when you need the widget family and related styling/state APIs grouped under iced::widget::rule.
