...
# Widget Module - iced::widget::slider

This page tracks the module entrypoint defined in ref/doc/iced/widget/slider/index.html.

## Overview

- Module name: slider
- Rustdoc: ref/doc/iced/widget/slider/index.html

## When to use

Use this module when you need the widget family and related styling/state APIs grouped under iced::widget::slider.
