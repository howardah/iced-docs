...
# Widget Module - iced::widget::toggler

This page tracks the module entrypoint defined in ref/doc/iced/widget/toggler/index.html.

## Overview

- Module name: toggler
- Rustdoc: ref/doc/iced/widget/toggler/index.html

## When to use

Use this module when you need the widget family and related styling/state APIs grouped under iced::widget::toggler.
